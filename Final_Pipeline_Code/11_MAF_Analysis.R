...
df_maf_stad$Tumor_Sample_Barcode <- gsub("^([A-Za-z0-9]+-[A-Za-z0-9]+-[A-Za-z0-9]+).*", "\\1",
                                         df_maf_stad$Tumor_Sample_Barcode)
## Filtering
...
## Visualization
## Summary
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Summary_All_Genes.png",
...
## Barplot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Barplot_Mutated_Genes_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Oncoplot_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
## Plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Titv_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
plotTiTv(res = df_final_titv)
dev.off()

## Lollipop amino acid changes
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_TP53_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
lollipopPlot(maf = df_final, gene = "TP53")
dev.off()

## Rainfall plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Rainfall_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
rainfallPlot(maf = df_final, detectChangePoints = TRUE, pointSize = 0.4)
dev.off()

## Mutation load against TCGA cohorts
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Mutation_Load_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
tcgaCompare(maf = df_final, cohortName = "Example-STAD", logscale = TRUE, capture_size = 50)
dev.off()

## Somatic Interactions
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Somatic_Interactions_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
## Forest plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Forest_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
forestPlot(mafCompareRes = high_low, pVal = 0.1)
dev.off()

## Co onco plots
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Co_Onco_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
coOncoplot(m1 = df_final_high, m2 = df_final_low, m1Name = "High", m2Name = "Low", removeNonMutated = TRUE)
dev.off()

## Co bar plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Co_Onco_Bar_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
coBarplot(m1 = df_final_high, m2 = df_final_low, m1Name = "High", m2Name = "Low")
dev.off()

## Oncogenic signaling pathways
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Signaling_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
pws <- pathways(maf = df_final, plotType = "treemap")
dev.off()

## Plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Signaling_Res_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
## Plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/All_Genes/Maf_Enrichment_All_Genes.png",
    width = 4000, height = 3500, units = "px", res = 300)
