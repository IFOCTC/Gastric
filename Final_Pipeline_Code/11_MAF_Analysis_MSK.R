...
## Mutations
df_mutated_genes_met  <- read.delim(paste0(data_path_mutations, "/Mutated_Genes.txt"))
df_cna_genes_met      <- read.delim(paste0(data_path_mutations, "/CNA_Genes.txt"))
## Survival
...
names(df_signature_stad)[names(df_signature_stad) == "X"] <- "Patient_ID"
...
## Visualization
## Summary
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Summary_MSK.png",
...
## Barplot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Barplot_Mutated_Genes_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Oncoplot_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
## Plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Titv_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
plotTiTv(res = df_final_titv)
dev.off()

## Lollipop amino acid changes
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_TP53_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
lollipopPlot(maf = df_final, gene = "TP53")
dev.off()

## Rainfall plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Rainfall_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
rainfallPlot(maf = df_final, detectChangePoints = TRUE, pointSize = 0.4)
dev.off()

## Mutation load against TCGA cohorts
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Mutation_Load_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
tcgaCompare(maf = df_final, cohortName = "Example-STAD", logscale = TRUE, capture_size = 50)
dev.off()

## Somatic Interactions
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Somatic_Interactions_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
## Forest plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Forest_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
forestPlot(mafCompareRes = high_low, pVal = 0.05)
dev.off()

## Co onco plots
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Co_Onco_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
coOncoplot(m1 = df_final_high, m2 = df_final_low, m1Name = "High", m2Name = "Low", removeNonMutated = TRUE)
dev.off()

## Co bar plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Bar_Co_Onco_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
coBarplot(m1 = df_final_high, m2 = df_final_low, m1Name = "High", m2Name = "Low")
dev.off()

## Oncogenic signaling pathways
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Signaling_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
pws <- pathways(maf = df_final, plotType = "treemap")
dev.off()

## Plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Signaling_Res_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
...
## Plot
png(filename = "/Users/ifo/Desktop/Docs/IFO/Gastric/Output/Maf_Analysis/MSK_Genes/Maf_Enrichment_MSK.png",
    width = 4000, height = 3500, units = "px", res = 300)
